 ...
 *
 * @remarks
 * Used by Rolliq libraries to precisely represent native currency (e.g. Ether), RUSD and RIQ
 * amounts, as well as derived metrics like collateral ratios.
 *
 * @public
 */
export class Decimal {
  static INFINITY = Decimal.fromBigNumberString(MAX_UINT_256);
  static ZERO = Decimal.from(0);
  static HALF = Decimal.from(0.5);
  static ONE = Decimal.from(1);
