...
/**
 * Amount of RUSD that's reserved for compensating the liquidator of a Trove.
 *
 * @public
 */
export const RUSD_LIQUIDATION_RESERVE = Decimal.from(200);

/**
 * A Trove must always have at least this much debt on top of the
 * {@link RUSD_LIQUIDATION_RESERVE | liquidation reserve}.
 *
 * @remarks
 ...
 * @public
 */
export const RUSD_MINIMUM_NET_DEBT = Decimal.from(1800);
 ...
 * @public
 */
export const RUSD_MINIMUM_DEBT = RUSD_LIQUIDATION_RESERVE.add(
