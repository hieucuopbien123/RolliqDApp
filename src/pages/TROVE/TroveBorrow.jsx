...
import { EditableRowM4 } from "./EditorM42";
  ...
  return (
    <>
      ...
      <FlexC justifyContent="space-between" alignItems="flex-end">
        <Text className="text-[#1E2185] fontCustom-bold text-[16px]">Borrow rUSD</Text>
      ...
      <FlexC justifyContent="space-between" alignItems="center">
        ...
        <Text className="fontCustom-Medium text-[18px] text-[#6B7280]">{totalDebt.toString(2)} rUSD</Text>
      </FlexC> */}
      ...
      <FlexC justifyContent="space-between" alignItems="center">
        ...
        <Text className="fontCustom-Medium text-[18px] text-[#6B7280]">{trove.debt.toString(2)} rUSD</Text>
      </FlexC>
      <Box style={{paddingTop: "8px"}}></Box>
      ...
      <Box sx={{ pt: [3, 4] }}>
        ...
        {stableTroveChange ? (
          <TroveActionM1
            ...
            maxBorrowingRate={maxBorrowingRate}
            borrowingFeeDecayToleranceMinutes={60}
            topmessage={`Borrowing ${netDebt.sub(trove.netDebt).prettify(2)} rUSD`}
          >
            Borrow
          </TroveActionM1>
        ) : (
          <Button disabled className="w-full fontCustom-bold animationCustom" style={{backgroundColor: "#1E2185", borderRadius: "25px", padding: "8px"}}>Borrow</Button>
        )}
        </Box>
    </>
  );
