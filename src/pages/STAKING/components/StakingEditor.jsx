...
import { EditableRowM5 } from "../../TROVE/EditorM52";
  ...
  return (
    <>
      ...
      <FlexC justifyContent="space-between" alignItems="center">
        ...
        <Text className="fontCustom-Medium text-[18px] text-[#6B7280]">{originalStake.stakedRIQ.prettify(2)} RIQ</Text>
      </FlexC>
      ...
      <FlexC justifyContent="space-between" alignItems="center">
        ...
        <Text className="fontCustom-Medium text-[18px] text-[#6B7280]">{totalStakedRIQ.prettify(2)} RIQ</Text>
      </FlexC>
      <Box style={{paddingTop: "8px"}}></Box>
