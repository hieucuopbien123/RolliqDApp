...
import { UnstakingEditor } from "./UnstakingEditor";
...
export const UnstakingPage = ({setCurrentPage, riqPrice}) => {
  ...
  return (
    <UnstakingEditor title={"Stake"} {...{ originalStake, editedRIQ, dispatch, setCurrentPage, riqPrice }}>
      <Box className="pb-4">
        {description ??
          (makingNewStake ? (
            <ActionDescriptionM1>
            ...
            <ActionDescriptionM1>
              Adjust the {GT} amount to withdraw.
            </ActionDescriptionM1>
          ))}
      </Box>
