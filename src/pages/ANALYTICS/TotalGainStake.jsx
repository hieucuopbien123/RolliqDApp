                ...
                <div className="px-[10px]">
                  ...
                  <ResponsiveContainer  width={"100%"} minWidth={isAnalyticsSmall ? "470px" : ""} height={300}>
                      ...
                      >
                        ...
                        <Line yAxisId="left" type="monotone" dataKey="thisDayGainsFromStaking" stroke="#235FC2" dot={false} />
                        <Line yAxisId="right" type="monotone" dataKey="thisDayGainsFromStakingInUsd" stroke="#22C55E" dot={false} />
                      </LineChart>
                    </ResponsiveContainer>
                  </Box>
                </div>
