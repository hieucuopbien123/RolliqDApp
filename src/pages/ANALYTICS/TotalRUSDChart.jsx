        ...
        <div className="flex flex-wrap gap-5 justify-between mb-1 p-[24px] max-[500px]:p-[15px]">
                ...
                <div className="px-[10px]">
                  ...
                  <LineChart
                    data={data}
                  >
                    <XAxis dataKey="date" scale="point" padding={{ left: 10, right: 10 }} interval={"preserveStartEnd"} stroke={"#191C6F"} tickSize={10} fontSize={12} color="#4B5563" dy={5} />
                    <YAxis yAxisId="left" stroke={"#191C6F"} tickFormatter={DataFormatter} tickSize={12} padding={{ bottom: 10, top: 10 }} dx={2} tickCount={10} fontSize={12}>
                    <Label style={{textAnchor:"middle",fill:"#191C6F",}} angle={-90} value={"rUSD"} position={"insideLeft"} fontSize={12}>

                    </Label>
                    </YAxis>
                    <Line yAxisId="left" type="monotone" dataKey="thisDayRUSDBorrowed" stroke="#235FC2" dot={false} />  
                  </LineChart>
                </ResponsiveContainer>
                </div>
                </div>
