...
import { StabilityDepositEditorM1 } from "./StabilityDepositEditorM1";
...
import { StabilityDepositEditorM2 } from "./StabilityDepositEditorM2";
...
export const SuppplyStabilityPool = ({setCurrentPage}) => {
      ...
      <Flex className="flex-col gap-2">
        {validChange ? (
          <StabilityDepositAction
            ...
            change={validChange}
            topmessage={`Supplying ${validChange.depositRUSD.prettify(2)} rUSD`}
          >
