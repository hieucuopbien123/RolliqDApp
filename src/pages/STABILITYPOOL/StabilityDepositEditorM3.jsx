...
import { EditableRowM5 } from "../TROVE/EditorM56";
...
export const StabilityDepositEditorM3 = ({
  originalDeposit,
  editedRUSD,
  changePending,
  dispatch,
  ...
  return (
    <>
      ...
      <FlexC justifyContent="space-between" alignItems="flex-end">
        <Text className="text-[#1E2185] font-bold">Withdrawing</Text>
        <div className="flex gap-3 max-[500px]:gap-1">
          <Text className="text-sm text-[#6B7280]">
            Supplied: {originalDeposit.currentRUSD.prettify(2)} rUSD
          </Text>
          <Button
            style={{
              padding: 0,
      ...
      <FlexC justifyContent="space-between" alignItems="center">
        <Text className="text-[#1E2185] text-[16px] fontCustom-bold flex gap-1 items-center">
          Your pool share
          <InfoIcon
            tooltip={
              <Card
